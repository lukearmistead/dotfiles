...
nmap <Leader>f :Files<CR>          " All files
nmap <Leader>l :BLines<CR>         " Lines in current buffer
nmap <Leader>L :Lines<CR>          " Lines in loaded buffers
nmap <Leader>/ :Ag<Space>          " Search for projects

"Calls MRU
nmap <Leader>r :MRU<CR>          " Opens MRU
